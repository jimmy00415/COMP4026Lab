...
faces, labels = prepare_training_data(str(data_dir / "training-data"))
print("Data prepared")
...
#load test images
test_img1 = cv2.imread(str(data_dir / "test-data" / "test1.jpg"))
test_img2 = cv2.imread(str(data_dir / "test-data" / "test2.jpg"))
